<?php require_once('/Users/jjying/Dropbox/IconMoon/news/plugins/modifier.repeat_count.php'); $this->register_modifier("repeat_count", "tpl_modifier_repeat_count");  require_once('/Users/jjying/Dropbox/IconMoon/news/plugins/function.checkActionsTpl.php'); $this->register_function("checkActionsTpl", "tpl_function_checkActionsTpl");  /* V2.20 Template Lite, 8 March 2008. (c) Mark Dickenson, Jon Langevin. GNU LGPL. 2013-10-12 09:52:43 CEST */ ?>
...
<br/>
			<select id="category" <?php if ($this->_vars['Multiple_Categories']): ?>name="category[]" multiple size=10<?php else: ?>name="category"<?php endif; ?> onchange="if ($('#category option:selected').val()>0) $('#lp-category').text($('#category option:selected').text()); else $('#lp-category').text('');">
