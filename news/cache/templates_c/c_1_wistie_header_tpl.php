<?php require_once('/Users/jjying/Dropbox/IconMoon/news/plugins/function.checkActionsTpl.php'); $this->register_function("checkActionsTpl", "tpl_function_checkActionsTpl");  /* V2.20 Template Lite, 8 March 2008. (c) Mark Dickenson, Jon Langevin. GNU LGPL. 2013-10-12 11:29:02 CEST */ ?>
...
'><i class="font-icon icon-star-alt"></i> <?php echo $this->_confs['PLIGG_Visual_Published_News']; ?>
</a></li>
	<li <?php if ($this->_vars['pagename'] == "upcoming"): ?>class="current"<?php endif; ?>><a href="<?php echo $this->_vars['URL_upcoming']; ?>
"><i class="font-icon icon-idea-alt"></i> <?php echo $this->_confs['PLIGG_Visual_Pligg_Queued']; ?>
</a></li>
	<li <?php if ($this->_vars['pagename'] == "submit"): ?>class="current"<?php endif; ?>><a href="<?php echo $this->_vars['URL_submit']; ?>
"><i class="font-icon icon-pencil-alt"></i> <?php echo $this->_confs['PLIGG_Visual_Submit_A_New_Story']; ?>
</a></li>
...
"><span><i class="font-icon icon-group-alt"></i> <?php echo $this->_confs['PLIGG_Visual_Profile']; ?>
</span></a></li><?php endif; ?>
	<?php if (isset ( $this->_vars['isgod'] ) && $this->_vars['isgod'] == 1): ?><li><a href="<?php echo $this->_vars['URL_admin']; ?>
"><span><i class="font-icon icon-wrench-alt"></i> <?php echo $this->_confs['PLIGG_Visual_Header_AdminPanel']; ?>
</span></a></li><?php endif; ?>
