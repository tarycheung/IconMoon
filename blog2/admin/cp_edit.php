...
<td width=10 align=center valign=top></td><td>
<div id='cateselarea'><span class="editor-label">分类</span>{$puttingcates}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="editor-label">标题</span><input type='text' name='title' id='title' class="editor-controls" value="{$records['title']}" size='50'  class='formtext'>
...
<tr bgcolor="#ffffff" align=left class="visibleitem">
<td width=10 valign=top align=center><div align=left><div style="display:none;">{$puttinghtml}<br>{$puttingubb}<br>{$puttingemot}<br></div></div>
</td>
<td>
eot;
...
<td><span class="editor-label-2">URL</span><input type=text class="editor-controls" name='blogalias' id='blogalias' value="{$records['blogalias']}" size="49">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="editor-label-2">显示属性</span><select name='summaryway' id='summaryway' onchange="if (this.options[this.selectedIndex].value=='1') {document.getElementById('entrysummary').style.display='block';} else {document.getElementById('entrysummary').style.display='none';}"><option value="0"{$entrysummaryplus0}>出现在首页</option><option value="2"{$entrysummaryplus2}>不显示在首页</option><option value="1"{$entrysummaryplus1}>{$lna[1115]}</option></select>
<div id='entrysummary' style='display: {$displaysummary};'><br />
...
<tr bgcolor="#ffffff" align=left class="hiddenitem">
<td width=10 valign=top align=center></td>
<td><span class="editor-label-2">Tags</span><input class="editor-controls" name='tags' autocomplete="off" id='tags' size='83' class='formtextarea'  value="{$records['tags']}" onfocus="simple_ac_init('tags', 'taghint')" {$tagdisable} />
...
<td width=10 valign=top align=center></td>
<td>
<span class="editor-label-2">{$lna[298]}</span>{$puttingproperty}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="editor-label">{$lna[300]}</span>{$puttingsticky}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=checkbox id='changemytime' name='changemytime' value=1 onclick="timechanger();"><span class="editor-label-3">更改时间</span>
