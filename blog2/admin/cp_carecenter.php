...
if ($job=='adminattach') {
	...
	if (count($detail_array)!=0) {
		foreach ($detail_array as $dafile) {
			...
			$tablebody.="<tr class='visibleitem'><td width=35 align=center><input type=checkbox name='selid[]' value='{$dafile['fid']}'></td><td align=center width=50%>{$dataoriginalname}</td><td align=center>{$time_t}</td><td width=35 align=center><a href=\"javascript: redirectcomfirm('admin.php?go=carecenter_delupload&filename={$dafile['fid']}');\"><img src='admin/theme/{$themename}/del.gif' alt='{$lna[78]}' title='{$lna[78]}' border='0'></a></td><td width=35 align=center><a href=\"{$dafile['filepath']}\"><img src='admin/theme/{$themename}/view.gif' alt='{$lna[782]}' title='{$lna[782]}' border='0'></a></td><td width=35 align=center><a href=\"admin.php?go=carecenter_updateattachment&fileid={$dafile['fid']}\"><img src='admin/theme/{$themename}/edit.gif' alt='{$lna[782]}' title='{$lna[782]}' border='0'></a></td></tr>";
		}
	}
