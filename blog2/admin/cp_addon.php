...
if ($job=='addplugin') {
	...
	$warn.="<b>{$lna[918]}</b><br><table width=95% align=center><tr><td width=20%>{$lna[919]}</td><td>{$info['name']}</td></tr><tr><td width=20%>{$lna[132]}</td><td>{$info['author']}  &nbsp; [<a href=\"{$info['authorurl']}\">{$lna[920]}</a>]</td></tr><tr><td width=20%>{$lna[921]}</td><td>{$info['version']}</td></tr><tr><td width=20%>{$lna[134]}</td><td>{$info['intro']}</td></tr></table><br><input type='checkbox' name='activate' value='1' checked>{$lna[922]}";
	$display_overall.=highlightadminitems('plugin', 'addon');
$display_overall.= <<<eot
