...
if (!$job || $job=="default") {
	...
	$message.="<table width=86% align=center class=\"adminoption\" ><tr><td width=25% valign=top align=center></td><td width=60%><input type=\"file\" name='newupfile[]'><br><input type=\"file\" name='newupfile[]'><br><input type=\"file\" name='newupfile[]'><br><input type=\"file\" name='newupfile[]'><br><input type=\"file\" name='newupfile[]'><br><br/></td></tr><tr><td colspan=10 align=center><input type='submit' value='{$lna[414]}' class='formbutton'></td></tr></table></form>";
