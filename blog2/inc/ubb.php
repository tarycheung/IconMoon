...
function convert_ubb ($str, $advanced=0, $inrss=0) {
	...
	$regubb_replace =  array(
				"makefontsize('\\1', '\\2')",
				"maketable('\\5','\\1','\\2','\\3','\\4')",
				"<div class=\"quote\"><link href=\"http://fonts.googleapis.com/css?family=Merriweather:400italic,700italic\" rel=\"stylesheet\" type=\"text/css\"><div class=\"quote-content\">\\1</div></div>",
...
function makeimginrss($src) {
	...
	$str="<br/><img src=\"{$config['blogurl']}/{$template['images']}/viewimage.gif\" alt=\"\"/><a href=\"{$src}\" >{$lnc[231]}</a><br/>[url]{$src}[/url]<br/>";
	return $str;
}
